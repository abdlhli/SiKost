                    ...
                    <div class="col-tb-1">
                        <div class="card-table">
                            <div class="card-body">
                                ...
                                include('method/databarang/TmbDataBarang.php');
                                include('method/databarang/EditDataBarang.php');
                                include('method/databarang/HapusDataBarang.php');
                                ?>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="table-responsive">
                                            <button type="button" class="btn btn-primary btn-xs" data-bs-toggle="modal" data-bs-target="#tmb_data_barang">
                                                <i class="bi-plus-lg">
                                            ...
                                            <table id="tbl" class="display" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    include('method/databarang/ViewDataBarang.php');
                                                    ?>
                                                </tbody>
                                            </table>
                                        </div>
